...
def test_case():
    ...
    breathing_issues = 'no,yes,no,yes,yes,no,yes,yes,yes,no,no,yes,yes,no'\
        .split(',')
    infected = 'no,yes,no,yes,yes,no,yes,yes,yes,yes,no,no,no,no'.split(',')
    ...
    try:
        if get_entropy_of_attribute(df, 'fever') >= 0.691 and \
           get_entropy_of_attribute(df, 'fever') <= 0.695 :
    ...
    try:
        if get_entropy_of_attribute(df, 'cough') >= 0.908 and \
           get_entropy_of_attribute(df, 'cough') <= 0.914:
